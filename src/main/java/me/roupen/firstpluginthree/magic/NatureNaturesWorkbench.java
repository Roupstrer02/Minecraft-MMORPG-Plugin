...
public class NatureNaturesWorkbench extends BukkitRunnable {
    /*
    ...
    public NatureNaturesWorkbench(Player caster)
    {
        origin = caster;
    ...
    public void spellStartup() {
        ...
        origin.openWorkbench(loc, true);
        origin.playSound(loc, Sound.UI_CARTOGRAPHY_TABLE_TAKE_RESULT, 1.0f, 1.0f);
    }
